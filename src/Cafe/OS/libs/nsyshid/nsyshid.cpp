...
namespace nsyshid
{
	...
	{
		cemuLog_logDebug(LogType::Force, "nsyshid.HIDAddClient(HIDClient_t, 0x{:08x})", callbackFuncMPTR);
	...
	{
		cemuLog_logDebug(LogType::Force, "nsyshid.HIDDelClient(HIDClient_t)");
	...
	{
		cemuLog_logDebug(LogType::Force, "nsyshid.HIDGetDescriptor(0x{:08x}, 0x{:02x}, 0x{:02x}, 0x{:04x}, outputData, 0x{:08x}, 0x{:08x}, 0x{:08x})",
	...
	{
		cemuLog_logDebug(LogType::Force, "nsyshid.HIDSetIdle(0x{:08x}, 0x{:02x}, 0x{:02x}, 0x{:02x}, 0x{:08x}, 0x{:08x})",
	...
	{
		cemuLog_logDebug(LogType::Force, "nsyshid.HIDSetProtocol(0x{:08x}, 0x{:02x}, 0x{:02x}, 0x{:08x}, 0x{:08x})",
	...
	{
		cemuLog_logDebug(LogType::Force, "nsyshid.HIDSetReport(0x{:08x}, 0x{:02x}, 0x{:02x}, data, 0x{:08x}, 0x{:08x}, 0x{:08x})",
	...
	{
		cemuLog_logDebug(LogType::Force, "nsyshid.HIDRead(0x{:08x},data,0x{:08x},0x{:08x},0x{:08x})",
	...
	{
		cemuLog_logDebug(LogType::Force, "nsyshid.HIDWrite(0x{:x},data,0x{:08x},0x{:08x},0x{:08x})",
						 hidHandle, maxLength, callbackFuncMPTR, callbackParamMPTR);
	...
	{
		cemuLog_logDebug(LogType::Force, "nsyshid.HIDDecodeError(0x{:08x},categoryPointer,codePointer)", 
						errorCode);
