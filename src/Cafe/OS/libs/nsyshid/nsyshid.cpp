...
namespace nsyshid
{
	...
	void _hidGetDescriptorAsync(std::shared_ptr<Device> device, uint8 descType, uint8 descIndex, uint8 lang, uint8* output, uint32 outputMaxLength, MPTR callbackFuncMPTR, MPTR callbackParamMPTR)
	{
	...
	sint32 _hidGetDescriptorSync(std::shared_ptr<Device> device, uint8 descType, uint8 descIndex, uint8 lang, uint8* output, uint32 outputMaxLength, coreinit::OSEvent* event)
	{
		sint32 returnCode = -1;
		if (device->GetDescriptor(descType, descIndex, lang, output, outputMaxLength))
		{
	...
	void export_HIDGetDescriptor(PPCInterpreter_t* hCPU)
	{
		...
		cemuLog_log(LogType::Force, "nsyshid.HIDGetDescriptor(0x{:08x}, 0x{:02x}, 0x{:02x}, 0x{:02x}, 0x{:x}, 0x{:08x}, 0x{:08x}, 0x{:08x})", hCPU->gpr[3],
	...
	void export_HIDSetIdle(PPCInterpreter_t* hCPU)
	{
		...
		cemuLog_log(LogType::Force, "nsyshid.HIDSetIdle(0x{:08x}, 0x{:02x}, 0x{:02x}, 0x{:02x}, 0x{:08x}, 0x{:08x})", hCPU->gpr[3],
	...
	void export_HIDSetProtocol(PPCInterpreter_t* hCPU)
	{
		...
		cemuLog_log(LogType::Force, "nsyshid.HIDSetProtocol(0x{:08x}, 0x{:02x}, 0x{:02x}, 0x{:08x}, 0x{:08x})", hCPU->gpr[3],
	...
	void export_HIDSetReport(PPCInterpreter_t* hCPU)
	{
		...
		cemuLog_log(LogType::Force, "nsyshid.HIDSetProtocol(0x{:08x}, 0x{:02x}, 0x{:02x}, 0x{:08x}, 0x{:08x}, 0x{:08x}, 0x{:08x})", hCPU->gpr[3],
	...
	void export_HIDRead(PPCInterpreter_t* hCPU)
	{
		...
		ppcDefineParamMPTR(callbackFuncMPTR, 3);  // r6
		ppcDefineParamMPTR(callbackParamMPTR, 4); // r7
		cemuLog_log(LogType::Force, "nsyshid.HIDRead(0x{:x},0x{:08x},0x{:08x},0x{:08x},0x{:08x})", hCPU->gpr[3],
					hCPU->gpr[4], hCPU->gpr[5], hCPU->gpr[6], hCPU->gpr[7]);
	...
	void export_HIDWrite(PPCInterpreter_t* hCPU)
	{
		...
		ppcDefineParamMPTR(callbackFuncMPTR, 3);  // r6
		ppcDefineParamMPTR(callbackParamMPTR, 4); // r7
		cemuLog_log(LogType::Force, "nsyshid.HIDWrite(0x{:x},0x{:08x},0x{:08x},0x{:08x},0x{:08x})", hCPU->gpr[3],
					hCPU->gpr[4], hCPU->gpr[5], hCPU->gpr[6], hCPU->gpr[7]);
	...
	void export_HIDDecodeError(PPCInterpreter_t* hCPU)
	{
		...
		cemuLog_log(LogType::Force, "nsyshid.HIDDecodeError(0x{:08x},0x{:08x},0x{:08x})", hCPU->gpr[3],
