...
void CemuConfig::Load(XMLConfigParser& parser)
{
	...
	emulated_usb_devices.emulated_dimensions_toypad = usbdevices.get("EmulateDimensionsToypad", emulated_usb_devices.emulated_dimensions_toypad);
}
...
void CemuConfig::Save(XMLConfigParser& parser)
{
	...
	usbdevices.set("EmulateDimensionsToypad", emulated_usb_devices.emulated_dimensions_toypad.GetValue());
}
